...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        // Middleware Laravel yang sering digunakan, pastikan semuanya ada di sini.
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            // \Illuminate\Session\Middleware\AuthenticateSession::class, // Dapat diaktifkan jika diperlukan
        ...
        'api' => [
            // Middleware API Laravel, biasanya untuk mengelola sesi dan throttling permintaan.
    ...
    /**
     * Alias middleware rute aplikasi.
     *
