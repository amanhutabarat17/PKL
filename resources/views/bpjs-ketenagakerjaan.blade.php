...
<body class="bg-gradient-to-br from-green-50 to-teal-50 min-h-screen antialiased">
    ...
    <!-- Tambahkan x-data untuk mengelola state menu utama -->
        ...
        <div class="flex justify-between items-center h-20 px-4 md:px-8 lg:px-12">
            <div class="flex items-center gap-10">
                <h1 class="flex items-center">
                    <!-- Logo di navbar - diperbesar dari w-40 menjadi w-52 -->
                ...
                <!-- Kelas `hidden` dihapus untuk memastikan menu muncul di desktop -->
