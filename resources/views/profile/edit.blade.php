    ...
    <div class="max-w-xl w-full mx-auto p-8 profile-card">
        ...
        <form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex items-center justify-between mt-6">
                <a href="{{ url('/user/bpjs-ketenagakerjaan') }}" class="inline-flex items-center btn-bpjs hover:bg-[#005f5f] text-white font-semibold py-2 px-4 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105 active:scale-95">
