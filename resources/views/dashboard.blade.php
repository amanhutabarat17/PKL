...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            /* Ensure filter and pagination remain visible */
            .dataTables_filter,
            .dataTables_length,
            .dataTables_info,
            .dataTables_paginate {
        ...
        $(document).ready(function () {
                ...
                $('.dataTables_filter').append(`
                    <div class="legend-container">
                        <div class="d-flex align-items-center gap-2">
                            <span style="display:inline-block;width:20px;height:20px;background:#CC0000;border:1px solid #000; border-radius: 4px;"></span>
                            <small>≤ 6 bulan</small>
                            <span style="display:inline-block;width:20px;height:20px;background:#FFFF00;border:1px solid #000; border-radius: 4px;"></span>
                            <small>> 6 bulan</small>
                        </div>
            ...
            $('#excelTable').Tabledit({
                ...
                onSuccess: function (data, textStatus, jqXHR) {
                    if (data.success) {
                        showStatusModal('success', 'Berhasil Diperbarui!', data.message ?? 'Data berhasil diperbarui!');
                        if (data.rowColor) {
                        ...
                        showStatusModal('error', 'Gagal!', data.message ?? 'Update gagal!');
                    }
                },
                onFail: function (jqXHR, textStatus, errorThrown) {
                    showStatusModal('error', 'Gagal!', 'Gagal update data: ' + errorThrown);
                }
            });

            // Custom Edit button (toggles to Save)
            $(document).on("click", ".btnEdit", function () {
                ...
                // If in edit mode, save
                    ...
                    $(this).html('<i class="fas fa-edit"></i>'); // change icon back to edit
